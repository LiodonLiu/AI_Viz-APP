    ...
    for x in range(50):
        for y in range(100):
            ...
            if (data[0]<200 or data[1]<200 or data[2]<200):
                ...
                canvas_img.putpixel((x + 350,y + 1050),change)

    d = ImageDraw.Draw(canvas_img)    #在图片下方显示对应的图片名
    d.text((150, 1700), 'front of ' + target, font=word_font, fill=(50, 50, 50))

    canvas_img.save(os.path.join('./foundImages/front of ' + target + '.jpg'))